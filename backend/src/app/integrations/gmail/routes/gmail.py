...
async def sync_email_applications(
    ...
    from src.app.modules.recruiting.models.job import Posts, JobStatus
    from src.app.modules.recruiting.models.application import Application as AppModel
    from src.app.modules.platform.users.models.user import UserRole as _UserRole
...
async def import_single_email_application(
    ...
    async def _run_screening(application_id: int) -> None:
        async with AsyncSessionLocal() as _sdb:
            from src.app.modules.recruiting.services.screening_service import ScreeningService as _SS

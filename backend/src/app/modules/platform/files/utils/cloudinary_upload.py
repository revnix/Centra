...
async def upload_file(file_bytes: bytes, filename: str, folder: str, resource_type: str = "auto") -> str | None:
    """
    ...
    try:
        ...
        logger.error(f"Cloudinary upload failed (resource_type={resource_type}, file={filename}): {e}")
        return None

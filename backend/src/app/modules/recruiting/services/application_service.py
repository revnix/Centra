...
class ApplicationService:
    ...
    async def get_application_by_id(self, application_id: int) -> Application | None:
        ...
        from src.app.modules.recruiting.models.interview_schedule import InterviewSchedule, InterviewPanelist, InterviewFeedback
        result = await self.db.execute(
            select(Application)
            .options(
    ...
    async def shortlist_candidate(self, application_id: int) -> Application:
        ...
        from src.app.modules.recruiting.services.scheduling_service import SchedulingService
    ...
    async def hire_candidate(self, application_id: int) -> Application:
        ...
        # Trigger Email
        from src.app.integrations.email.services.service import EmailService
        from src.app.modules.recruiting.services.onboarding_service import OnboardingService
    ...
    async def ensure_resume_promoted_to_drive(self, user_id: int, job_folder_name: Optional[str] = None):
        ...
        try:
            ...
            from src.app.integrations.google_drive.services.service import GoogleDriveService

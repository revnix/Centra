...
from src.app.modules.recruiting.schemas.job import JobCreate, JobUpdate
...
class JobService:
    ...
    async def generate_draft(self, draft_in: any):
        from src.app.modules.recruiting.services.jd_generator_service import JDGeneratorService
    ...
    async def publish_job(self, job_id: int, user_id: int):
        from src.app.modules.recruiting.models.job import JobStatus
        from datetime import datetime, timezone
        from src.app.integrations.indeed.services.service import IndeedService

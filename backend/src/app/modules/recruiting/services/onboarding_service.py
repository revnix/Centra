...
class OnboardingService:
    ...
    async def get_hr_onboarding_details(self, application_id: int) -> dict:
        from src.app.modules.recruiting.models.application import Application
        from src.app.modules.recruiting.models.onboarding import OnboardingDocument
        from src.app.modules.recruiting.models.job import Posts
    ...
    async def upload_onboarding_documents(
        ...
        from src.app.modules.platform.files.services.file_service import FileService

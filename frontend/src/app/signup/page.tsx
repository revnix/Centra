...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // Default role is handled via role-based access later.
      // For now, we create a standard candidate account.
      ...
      // Standard user lands on portal profile/dashboard (jobs + applications status)
      ...
      <div className="hidden lg:flex flex-col justify-between w-5/12 p-12 bg-[#1e1b4b] text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-200/80 text-base leading-relaxed mb-8">
            Set up your AI hiring workspace in minutes. Automate candidate
            screening and interview workflows instantly.
          </p>
          <div className="space-y-3">
            {[
              "Free trial, no credit card required",
              "Full AI screening & Kanban pipeline",
              "Cancel anytime",
            ].map((f) => (
